...
declare module 'vue-router/auto/routes' {
  export interface RouteNamedMap {
    ...
    'patients-visits-components-notes-vue': RouteRecordInfo<'patients-visits-components-notes-vue', '/patients/visits/components/notesVue', Record<never, never>, Record<never, never>>,
    'patients-visits-components-occupation-hx': RouteRecordInfo<'patients-visits-components-occupation-hx', '/patients/visits/components/occupationHx', Record<never, never>, Record<never, never>>,
    'patients-visits-components-past-hx': RouteRecordInfo<'patients-visits-components-past-hx', '/patients/visits/components/pastHx', Record<never, never>, Record<never, never>>,
    'patients-visits-components-personal-hx': RouteRecordInfo<'patients-visits-components-personal-hx', '/patients/visits/components/personalHx', Record<never, never>, Record<never, never>>,
    'patients-visits-components-present-illness': RouteRecordInfo<'patients-visits-components-present-illness', '/patients/visits/components/presentIllness', Record<never, never>, Record<never, never>>,
    'patients-visits-components-present-illness-child': RouteRecordInfo<'patients-visits-components-present-illness-child', '/patients/visits/components/presentIllnessChild', Record<never, never>, Record<never, never>>,
    'patients-visits-components-social-hx': RouteRecordInfo<'patients-visits-components-social-hx', '/patients/visits/components/socialHx', Record<never, never>, Record<never, never>>,
    'patients-visits-components-tests-vue': RouteRecordInfo<'patients-visits-components-tests-vue', '/patients/visits/components/testsVue', Record<never, never>, Record<never, never>>,
    'patients-visits-components-therapy-vue': RouteRecordInfo<'patients-visits-components-therapy-vue', '/patients/visits/components/therapyVue', Record<never, never>, Record<never, never>>,
    ...
    'patients-visits-open-new': RouteRecordInfo<'patients-visits-open-new', '/patients/visits/open/new', Record<never, never>, Record<never, never>>,
    'patients-visits-open-old': RouteRecordInfo<'patients-visits-open-old', '/patients/visits/open/old', Record<never, never>, Record<never, never>>,
